...
def runtime_policy(label, code):
    slow = label in {'phase1-status-fix-r1','interaction-audit-r1','daily-briefing-r2','phase2-r1','brand-sidebar-r1','ui-controls-r2','sidebar-shell-r2'}
...
for forbidden in ['src="patch-loader.js',"src='patch-loader.js",'src="patch-loader-fast-r1.js',"src='patch-loader-fast-r1.js",'data/0.txt','finance-phase1-r1.js','finance-phase1-r2.js','finance-daily-briefing-r1.js','"ui-controls-r1"']:
