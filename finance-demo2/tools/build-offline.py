...
def runtime_policy(label, code):
    slow = label in {'phase1-status-fix-r1','interaction-audit-r1','daily-briefing-r2','phase2-r1','brand-sidebar-r1','ui-controls-r2'}
