(()=>{
  ...
  if('serviceWorker' in navigator&&location.protocol.startsWith('http'))navigator.serviceWorker.register('./sw.js?v=finance-offline-r1-20260829').catch(e=>console.warn('PAVENRO service worker',e));
