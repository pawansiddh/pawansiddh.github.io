...
assert.match(html,/src="nestlyra-v42\.js\?v=49"/);
assert.match(html,/src="pavenro-brand\.js\?v=49"/);
assert.match(html,/src="focus-professional-v49\.js\?v=49"/);
...
assert.match(worker,/tulshii-focus-v49-professional-audit/);
