...
assert.match(html,/src="groups\.js\?v=42"/);
assert.match(html,/src="nestlyra-v39\.js\?v=42"/);
assert.match(html,/src="nestlyra-v42\.js\?v=42"/);
...
assert.match(worker,/nestlyra-focus-v42-stable-modules/);
