...
assert.match(html,/href="tulshii-auth-v58\.css\?v=60"/);
assert.match(html,/src="tulshii-login-lockup\.svg" alt="TULSHII\.com"/);
...
assert.match(worker,/tulshii-focus-v60-login-brand-lockup/);
assert.match(worker,/\.\/tulshii-login-lockup\.svg/);
