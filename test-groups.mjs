...
assert.match(html,/src="groups\.js\?v=43"/);
assert.match(html,/src="nestlyra-v39\.js\?v=43"/);
assert.match(html,/src="nestlyra-v42\.js\?v=43"/);
...
assert.match(worker,/nestlyra-focus-v43-responsive-repair/);
