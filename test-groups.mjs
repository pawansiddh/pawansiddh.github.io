...
assert.match(html,/One secure PAVENRO account/);
assert.match(html,/src="groups\.js\?v=45"/);
assert.match(html,/src="nestlyra-v39\.js\?v=45"/);
assert.match(html,/src="nestlyra-v42\.js\?v=45"/);
assert.match(html,/src="pavenro-brand\.js\?v=45"/);
...
assert.match(worker,/pavenro-focus-v48-shell-categories/);
