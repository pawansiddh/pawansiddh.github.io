...
assert.match(html,/tulshiiFocusOffline\.workspace\.v6/,'Download must use a versioned offline workspace store');
assert.match(html,/tulshiiFocusOffline\.appearance\.v6/,'Download must isolate its appearance from older and online editions');
assert.match(html,/tulshiiFocusOffline\.preferences\.v6/,'Download must isolate its briefing and voice preferences');
