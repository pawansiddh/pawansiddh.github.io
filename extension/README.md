# Study Tracker Job Capture

Free Chrome/Edge extension for transferring a visible job posting into the Study Tracker.

## Install

1. Download and unzip `study-tracker-job-capture.zip`.
