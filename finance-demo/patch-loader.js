(async()=>{
  ...
  try{
    ...
    await loadScript('finance-final-r3j.js?v=finance-final-r3j-20260828');
  }catch(e){
    ...
    try{await loadScript('finance-final-r3j.js?v=finance-final-r3j-20260828-fallback')}catch(_){ }
  }
})();
