(async()=>{
  ...
  try{
    ...
    await loadScript('finance-debt-lab-r1.js?v=finance-debt-control-r1-20260828');
  }catch(e){
    ...
    try{await loadScript('finance-debt-lab-r1.js?v=finance-debt-control-r1-20260828-fallback')}catch(_){ }
  }
})();